CREATE TABLE User(userid INT AUTO_INCREMENT, username VARCHAR(20), type VARCHAR(5), firstname VARCHAR(20), lastname VARCHAR(20), dogid INT, password VARCHAR(20), PRIMARY KEY(userid));
